<div>
    ...
    {{-- sidebar --}}
    <div class="absolute top-0 -left-60 bg-[#EEEEEE] md:static transition-all duration-200 z-20 shadow-lg md:shadow-none"
        id="sidebar">
        <div class="flex flex-col justify-between px-6 py-10 md:px-8 md:py-14 h-screen w-64">
            ...
            <div class="flex flex-col items-center">
                ...
                @if (session('username'))
                    <div class="flex items-center mt-4 bg-white px-4 py-2 rounded-full shadow-sm">
                        <svg xmlns="http://www.w3.org/2000/svg" class="size-5 text-[#222831]" viewBox="0 0 24 24"
            ...
            <nav class="flex-1 mt-10">
                <ul class="space-y-3">
                    ...
                    <li>
                        <a href="/"
                            class="flex items-center gap-4 rounded-lg p-3 w-full font-medium
...
{{-- add income --}}
<li>
    <a href="/add-income" class="flex items-center gap-4 rounded-lg p-3 w-full font-medium
        {{ request()->is('add-income') ? 'bg-[#222831] text-white' : 'hover:bg-[#222831] hover:text-white text-[#222831]' }}">
        <!-- Wallet with arrow up for Income -->
        <svg xmlns="http://www.w3.org/2000/svg" class="size-5" viewBox="0 0 24 24" fill="currentColor">
            <path d="M21 7H5a2 2 0 0 0-2 2v9a2 2 0 0 0 2 2h16a2 2 0 0 0 2-2V9a2 2 0 0 0-2-2zm0 11H5V9h16zm-8 1v-2H8v-2h5v-2l3 3-3 3z"/>
        </svg>
        Add Income
    </a>
</li>
                    ...
                    <li>
                        <a href="/add-goal"
                            ...
                            <svg xmlns="http://www.w3.org/2000/svg" class="size-5" viewBox="0 0 24 24"
                                fill="currentColor">
                                <path
                                    d="M12 2a10 10 0 1 0 3.49 19.39l-.66-1.89A8 8 0 1 1 20 12h2a10 10 0 0 0-10-10zm0 4a6 6 0 1 0 1.95 11.66l-.65-1.87a4 4 0 1 1 2.57-2.57l1.87.65A6 6 0 0 0 12 6zm0 4a2 2 0 1 0 1.41 3.41l4.59 4.59L20 16l-4.59-4.59A2 2 0 0 0 12 10z" />
                            </svg>
                            Add Goal
                        </a>
                    </li>
                    ...
                    <li>
                        <a href="/analytics"
                            ...
                            <svg xmlns="http://www.w3.org/2000/svg" class="size-5" viewBox="0 0 24 24"
                                fill="currentColor">
                                <path
                                    d="M5 21q-.825 0-1.412-.587T3 19V5q0-.825.588-1.412T5 3h14q.825 0 1.413.588T21 5v14q0 .825-.587 1.413T19 21zm3-11q-.425 0-.712.288T7 11v5q0 .425.288.713T8 17t.713-.288T9 16v-5q0-.425-.288-.712T8 10m4-3q-.425 0-.712.288T11 8v8q0 .425.288.713T12 17t.713-.288T13 16V8q0-.425-.288-.712T12 7m4 6q-.425 0-.712.288T15 14v2q0 .425.288.713T16 17t.713-.288T17 16v-2q0-.425-.288-.712T16 13" />
                            </svg>
                            Analytics
                        </a>
                    </li>
            ...
            <div class="mt-6">
                <a href="/logout"
                    class="flex items-center gap-4 rounded-lg p-3 w-full font-medium hover:bg-red-500 hover:text-white text-[#222831]">
                    <svg xmlns="http://www.w3.org/2000/svg" class="size-5 rotate-180" viewBox="0 0 48 48" fill="none"
